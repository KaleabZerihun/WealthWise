            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::guard('advisor')->check())
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('advisor.dashboard')" :active="request()->routeIs('advisor.dashboard')" wire:navigate>
                    ...
                    @else
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            <x-nav-link :href="route('portfolio')" :active="request()->routeIs('portfolio')" wire:navigate>
                                {{ __('Portfolio') }}
                            </x-nav-link><x-nav-link :href="route('user.appointments')" :active="request()->routeIs('user.appointments')" wire:navigate>
                                {{ __('Appointments') }}
                            </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @elseif(Auth::guard('advisor')->check())
                            <x-dropdown-link :href="route('advisor.profile')" wire:navigate>
                                {{ __('Profile') }}
                            </x-dropdown-link>
                        @else
                            <!-- Default to user -->
